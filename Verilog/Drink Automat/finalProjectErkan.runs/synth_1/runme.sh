...
HD_PWD='C:/Users/Egeha/Desktop/Erkan Digital Design/finalProjectErkan/finalProjectErkan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log drinkAutomat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source drinkAutomat.tcl
